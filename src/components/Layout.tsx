...
const shopLinks: { id: View; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { id: "invoices", label: "Invoices", icon: Store },
...
const customerLinks: {
  ...
  { id: "dashboard", label: "Overview", icon: LayoutDashboard },
  { id: "purchases", label: "My purchases", icon: Store },
  { id: "warranties", label: "My warranties", icon: Settings },
  { id: "upload", label: "Add online purchase", icon: Upload },
      ...
      <aside className="sidebar">
        <div className="side-top">
          ...
          <span className="workspace-label">
            {role === "shopkeeper" ? "WORKSPACE" : "MY ACCOUNT"}
          </span>
        </div>
        {role === "shopkeeper" && (
          <Button
            className="create-button"
            onClick={() => onView("create-invoice")}
          >
            <Plus size={17} />
            Create invoice
          </Button>
        ...
        <nav className="side-nav" aria-label="Main navigation">
          <button
            onClick={() => onView(first.id)}
            className={view === first.id ? "active" : ""}
          >
            <first.icon size={18} />
            {first.label}
          </button>
        ...
        <div className="side-bottom">
          ...
          >
            <Bell size={18} />
            Notifications{notifications > 0 && <b>{notifications}</b>}
          </button>
          <button
          ...
          <a
            ...
            href="mailto:meetsharma0702@gmail.com?subject=BillNest%20support"
          >
            <HelpCircle size={18} />
            Support: Meet Sharma
          </a>
      ...
      <main className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <label className="theme-control" title="Choose theme">
            ...
            <button className="profile-chip" onClick={() => onView("settings")}>
